                                    ...
                                    <div class="nk-tb-col tb-col-sm">
                                        <div class="user-card">
                                            <div class="user-avatar user-avatar-sm bg-warning">
                                                <img src="{{ asset('/') }}admin/images/avatar/b-sm.jpg" alt="">
                                            </div>
                                            <div class="user-name">
                    ...
                    <div class="card card-bordered card-full">
                        ...
                        <ul class="nk-activity">
                            <li class="nk-activity-item">
                                <div class="nk-activity-media user-avatar bg-success"><img src="{{ asset('/') }}admin/images/avatar/c-sm.jpg" alt=""></div>
                            ...
                            <li class="nk-activity-item">
                                <div class="nk-activity-media user-avatar bg-purple"><img src="{{ asset('/') }}admin/images/avatar/d-sm.jpg" alt=""></div>
                                <div class="nk-activity-data">
                        ...
                        <ul class="nk-support">
                            <li class="nk-support-item">
                                <div class="user-avatar">
                                    <img src="{{ asset('/') }}admin/images/avatar/a-sm.jpg" alt="">
                                </div>
